...
def homepage():
    ...
    for (ex,ey,ew,eh) in eyes:
        ...
        circles = cv2.HoughCircles(thresh1,cv.CV_HOUGH_GRADIENT,params.hResolutionScale,params.hMinCircDist, param1=params.cMinVal, param2=params.hAccum, minRadius=params.hMinRadius)
        try:
        ...
        try:
            ...
            for i in circles[0,:]:
                ...
                circles = cv2.HoughCircles(threshLight,cv.CV_HOUGH_GRADIENT,params.lhResolutionScale,params.lhMinCircDist, param1=params.lcMinVal, param2=params.lhAccum, minRadius=1)
                circles = np.uint16(np.around(circles))
